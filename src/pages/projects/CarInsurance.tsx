  ...
  return (
    <div className="container-responsive py-12 space-y-10">
      <header className="space-y-3">
        <h1 className="text-3xl font-semibold">Car Insurance — Quote Flow</h1>
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground">
          Hohe Abbruchraten im Angebotsprozess; Nutzer fanden die Preisoptionen schwer vergleichbar.
        </p>
      </section>
      ...
      <section className="space-y-6">
        ...
        <figure className="space-y-2">
          <img
            src={imgPricing}
            alt={t('captions.adacPricing')}
            className="w-full rounded-2xl border border-border"
          />
          <figcaption className="text-sm text-muted-foreground">
            {t('captions.adacPricing')}
          </figcaption>
        </figure>
        ...
        <figure className="space-y-2">
          <img
            src={imgHeat}
            alt={t('captions.adacHeatmap')}
            className="w-full rounded-2xl border border-border"
          />
          <figcaption className="text-sm text-muted-foreground">
            {t('captions.adacHeatmap')}
          </figcaption>
        </figure>
      </section>
