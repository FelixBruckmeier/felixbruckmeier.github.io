    ...
    <main>
      <section id="hero" className="max-w-6xl mx-auto px-4 py-12 md:py-16">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-3xl md:text-5xl font-bold mb-3">{t("hero_title" as any)}</h1>
            <p className="text-neutral-600 dark:text-neutral-300 mb-6">{t("hero_sub" as any)}</p>
      ...
      <section id="about" className="max-w-6xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-semibold mb-4">{t("about_title" as any)}</h2>
      ...
      <section id="expertise" className="max-w-6xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-semibold mb-6">{t("expertise_title" as any)}</h2>
        <HouseDiagram />
      </section>

      <section id="projects" className="max-w-6xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-semibold mb-4">{t("projects_title" as any)}</h2>
      ...
      <section id="cv" className="max-w-6xl mx-auto px-4 py-12">
        <h2 className="text-2xl font-semibold mb-4">{t("cv_title" as any)}</h2>
