...
export default function Imprint() {
  return (
    <Section id="imprint" title="Imprint" spacing="lg">
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Tile variant="static" className="md:col-span-2">
          ...
          <p className={`${typography.body.size} ${typography.body.leading}`}>
            This website is a private, non-commercial portfolio project. 
            It is not intended for business purposes, but serves solely to
            present selected work and expertise.
          </p>
        </Tile>
      </div>
    </Section>
