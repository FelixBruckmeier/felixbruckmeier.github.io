...
import RolesSpider from "@/components/expertise/TeamLeadership/RolesSpider"; // Spider-Chart für Rollen
    ...
    <div className="flex flex-col gap-20 px-6 md:px-12 lg:px-24 py-12 max-w-7xl mx-auto">
      ...
      <Section title="Skill Assessment & Entwicklung">
        ...
        <div className="flex justify-center">
          <Link
            to="/expertise/team-leadership/skills" // ✅ neuer korrekter Pfad
