...
export default function Footer() {
  ...
  return (
    <footer className={cn("border-t", colors.border)}>
      <Section id="footer" border={false} spacing="sm" className="py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p
            className={cn(
              ...
              colors.muted.text // 👈 ersetzt text-muted-foreground
            )}
          >
          ...
          >
            <Link
              className={cn(
                colors.muted.text,
                "hover:underline hover:opacity-80" // 👈 ersetzt hover:text-foreground
              )}
              to="/imprint"
            >
              Imprint
