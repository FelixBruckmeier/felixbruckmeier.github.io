  ...
  const steps = [
    {
      ...
      desc: (
        <>
          As part of the <strong>homepage redesign</strong> and visual rebranding,
          the pricing components — such as <strong>discounts, color cues, and strikethrough prices</strong> —
          needed to be re-evaluated.  
          The goal was not only aesthetic consistency, but also a measurable
          <strong> improvement in user comprehension and trust</strong>.
          As <strong>UX Research Lead</strong>, I designed and facilitated this usability testing
          to ensure that design and UX performance aligned across product contexts.
        </>
      ),
      img: researchPlanImg,
    },
    {
      ...
      desc: (
        <>
          ...
          <strong>20 participants</strong> — all pet owners with online shopping experience — 
          were asked to perform key purchase-related tasks across <strong>Homepage</strong>,
          <strong> PLP</strong>, <strong>PDP</strong>, and <strong>Cart</strong>.
          The session structure combined <strong>task performance</strong> and <strong>open reflection</strong>
          to surface both usability and perception issues.
        </>
      ),
      img: prototypeImg,
    },
    {
      ...
      desc: (
        <>
          ...
          <strong> discount visibility</strong> were central to trust.
          Users understood the pricing logic faster when <strong>crossed-out prices</strong>
          and <strong>percentage savings</strong> were visually grouped.  
          Ambiguities arose when discount badges competed with product imagery.
          Based on these insights, we redefined the pricing logic display
          to be <strong>consistent, legible, and emotionally confident</strong> across contexts.
        </>
      ),
      img: findingsImg,
    },
    {
      ...
      desc: (
        <>
      The <strong>user journey</strong> showed how pricing perception evolved across touchpoints:  
      <br />
      <strong>Homepage:</strong> Price as brand signal and entry point.  
      <br />
      <strong>PLP:</strong> Price as comparison and decision filter.  
      <br />
      <strong>PDP:</strong> Price as value judgment balancing quality, size, and discounts.  
      <br />
      <strong>Cart:</strong> Price as confirmation and trust moment.  
      <br />
      While initial impressions were positive, <strong>unclear price components</strong> 
      (e.g., “subscription vs. promotion,” “per-unit vs. total”) caused hesitation — 
    ...
    },
    {
      ...
      desc: (
        <>
          ...
          <strong> VisAWI questionnaire</strong> to measure users’ perception
          of <strong>visual aesthetics, consistency, and clarity</strong>.
          This provided a benchmark for visual design quality
          — helping ensure that functional clarity aligned with brand expression.
        </>
      ),
      component: <VisAWI />,
    },
