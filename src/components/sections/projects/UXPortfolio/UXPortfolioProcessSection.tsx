...
export function UXPortfolioProcessSection() {
  return (
    ...
    >
      ...
      {/* ✅ Align like your other sections: centered block, consistent width, consistent top spacing */}
      <div className={cn("w-full flex justify-center", spacing.mt12)}>
        <div className="w-full md:w-3/4 text-left space-y-12">
