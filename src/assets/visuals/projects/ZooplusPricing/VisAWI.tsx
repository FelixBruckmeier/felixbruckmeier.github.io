  ...
  return (
    <div className="w-full border border-border rounded-2xl p-6 bg-background shadow-md">
      <h3 className="text-xl font-semibold mb-4">
        VisAWI Results (Visual Aesthetics of Websites Inventory)
      </h3>
      <p className="text-muted-foreground mb-6 text-sm leading-relaxed">
        Comparison of measured values (zooplus Pricing Study) with published
        reference values from web-based studies (VisAWI-S). Scale: 1 (low) – 7 (high).
      </p>
      ...
      <div className="mt-6 space-y-3 text-base">
        <p className="flex items-center">
          ...
          <span className="text-[#2563EB] font-medium">zooplus Pricing Study</span> – results from the internal usability study.
        </p>
        <p className="flex items-center">
          <span className="inline-block w-3 h-3 rounded-full bg-[#93C5FD] mr-2"></span>
          <span className="text-[#93C5FD] font-medium">Reference values (VisAWI-S)</span> – published means from web studies.
        </p>
